...
export const TikTokIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
    <path d="M19.589 6.686a4.793 4.793 0 0 1-3.77-4.245V2h-3.445v13.672a2.896 2.896 0 0 1-5.201 1.743l-.002-.001.002.001a2.895 2.895 0 0 1 3.183-4.51v-3.5a6.329 6.329 0 0 0-5.394 2.15 6.341 6.341 0 0 0 1.077 8.761 6.34 6.34 0 0 0 8.836-1.579 6.3 6.3 0 0 0 1.01-3.513V9.167a8.231 8.231 0 0 0 4.673 1.442V7.127a4.854 4.854 0 0 1-1.97-.441z"/>
  </svg>
);
