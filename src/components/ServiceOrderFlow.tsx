...
export const ServiceOrderFlow: React.FC<ServiceOrderFlowProps> = ({
  ...
  const [quantityStr, setQuantityStr] = useState<string>(String(service.minQuantity || 1000));
          ...
          <div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
            <section className="rounded-[28px] border-4 border-black bg-white p-5 sm:p-6 shadow-[8px_8px_0px_#000000]">
              ...
              <div className="space-y-4 text-sm font-bold text-zinc-700">
                ...
                <div className="rounded-2xl border-2 border-black bg-black p-3 text-white">
                  <p className="text-[10px] uppercase text-zinc-300">{t.pricePer1000Label}</p>
            ...
            <section className="rounded-[28px] border-4 border-black bg-white p-5 sm:p-6 shadow-[8px_8px_0px_#000000]">
              ...
              <div className="space-y-5">
                <div>
                  <label className="mb-2 block text-xs font-black text-zinc-700">{t.quantityLabel}</label>
                  <input
                    type="text"
                    inputMode="numeric"
                    value={quantityStr}
                    ...
                    onBlur={() => {
                      ...
                      if (num < (service.minQuantity || 1000)) {
                        setQuantityStr(String(service.minQuantity || 1000));
                      }
                    }}
                    placeholder={`الحد الأدنى ${service.minQuantity || 1000}`}
