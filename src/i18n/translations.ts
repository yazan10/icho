...
export const translations = {
  ar: {
    ...
    // Footer
    footerDesc: 'منصة النمو الرقمي 3D الأولى لتطوير الحسابات على شبكات التواصل الاجتماعي بأمان تام وخوادم عالية السرعة.',
  ...
  en: {
    ...
    // Footer
    footerDesc: 'The premier 3D digital growth platform for expanding social media accounts safely and fast.',
